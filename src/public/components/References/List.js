...
const References = (props) => {
  ...
  const data = [
    ...
    {
      name: 'Danielle Pillion',
      image: 'https://media-exp1.licdn.com/dms/image/C4E03AQEskeYwidvmfw/profile-displayphoto-shrink_800_800/0?e=1590624000&v=beta&t=KmXwe929yWv0Ym4H_NS67joqSu9I_4tUsfl96er7rMo',
      link: 'https://www.linkedin.com/in/daniellepillion/',
      title: 'Passionate about technical product management',
  ...
  // TODO: Split out <Reference/> into two components
  //       One that is "Large" and another "Small" this
  //       way I can handle them differently
  const Items = () => list.map((ref, index) => (
    <li key={index} className="ReferencesComponent__listItem">
      <Reference {...ref} />
    </li>
  ));

  return (
    <ul className="ReferencesComponent">
      <Items/>
      <ShowMore
        display={limit < data.length}
...
const ShowMore = ({ display, onClick }) => {
